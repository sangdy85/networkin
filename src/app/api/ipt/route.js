...
export async function POST(req) {
  try {
    ...
    const stmt = db.prepare(`
      INSERT INTO ipt_items (id, client_id, work_type, custom_work_type, title, start_date, start_time, end_date, end_time, include_weekends, site, workers, content, status, file_name, file_path)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `);
